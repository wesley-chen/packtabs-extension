...
declare module '#imports' {
  ...
  export { StorageQuotaExceededError, StorageQuotaExceededError, StorageSyncConflictError, StorageSyncConflictError, saveTabGroup, getTabGroups, updateTabGroup, deleteTabGroup, deleteTabFromGroup, StorageService } from '../utils/storage';
  export { TabPermissionDeniedError, TabPermissionDeniedError, TabNotFoundError, TabNotFoundError, InvalidUrlError, InvalidUrlError, captureCurrentWindow, openTabs, openSingleTab, closeCurrentTabs, TabManager } from '../utils/tabManager';
}
